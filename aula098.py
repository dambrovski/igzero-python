...
class Jogo(object):
    ...
    def novoJogo(self):
        ...
        """
        self.playter = self.canvas.create_rectangle((CANVAS_L//2, 350), (CANVAS_L//2 + 100, 370), fill = 'blue')

        #cria bola do jogo
        raio = 30
        p = (100, 200)
        self.bola = self.canvas.create_oval(p[0], p[1], p[0] + raio, p[1] + raio, fill='red', outline='black', tag = 'bola')
